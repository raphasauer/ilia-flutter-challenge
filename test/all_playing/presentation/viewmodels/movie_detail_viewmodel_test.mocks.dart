...
// in ilia_flutter_challenge/test/all_playing/presentation/viewmodels/movie_detail_viewmodel_test.dart.
...
class MockCacheService extends _i1.Mock implements _i9.CacheService {
  @override
  String get cacheName => (super.noSuchMethod(
        Invocation.getter(#cacheName),
        returnValue: '',
        returnValueForMissingStub: '',
      ) as String);

  @override
  dynamic getCachedData(String? key) => super.noSuchMethod(
        Invocation.method(
          #getCachedData,
          [key],
        ),
